...
from keymaster.models import Permission
from keymaster.forms import PermissionForm
...
def PermissionList(request):
    ...
    return render(request, 'keymaster/permission/list.html', context)

@login_required
def PermissionCreate(request):
    permissionform = PermissionForm()

    return render(request, 'keymaster/permission/create.html', {
        'permissionform': permissionform,
    })
