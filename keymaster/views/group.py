...
from keymaster.models import Group, KeyGroup, Key
from keymaster.forms import GroupForm
...
def GroupList(request):
    ...
    return render(request, 'keymaster/group/list.html', context)
...
def GroupDetail(request):
    ...
    return render(request, 'keymaster/group/detail.html', {
        'groupform': groupform,
    })
